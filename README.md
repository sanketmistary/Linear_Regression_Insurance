...
This project demonstrates a simple linear regression model to predict medical insurance costs based on various features. 
The notebook covers data loading, exploratory data analysis, outlier removal, feature engineering, model training, and evaluation.
